...
void main() {
  ...
  group("User profile test for tablet in dark mode", () {
    late final MockDatabaseService mockDatabaseService;
    late final MockNotificationService mockNotificationService;
    ...
    testWidgets(
        "User profile of the current user renders correctly and navigations work for tablet layout in dark mode",
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1194.0, 834.0);
      tester.view.devicePixelRatio = 1.0;
      AuthService.setUid('test');
        ...
        ProviderScope(
          ...
          child: MediaQuery(
            data: const MediaQueryData(
                platformBrightness: Brightness.dark, size: Size(1194.0, 834.0)),
            child: CupertinoApp(
                home: ResponsiveLayout(
              mobileLayout: UserProfile(
                user: AuthService.uid,
    ...
    testWidgets(
        "User profile of another user renders correctly and navigations work for tablet layout in dark mode",
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1194.0, 834.0);
      tester.view.devicePixelRatio = 1.0;
      AuthService.setUid('test');
